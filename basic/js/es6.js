...
// // 배열의 각 아이템에 10을 곱해야 한다

// let updateArr = arr.map(function (item) {
//     //item: 배열의 각 아이템
//     return item * 10;
// })

// console.log(updateArr); // 10, 20, 30
...
// // 파라미터 이름은 바꿀 수 있다
// let updateBeers = beers.map(function(beer) {
...
// console.log(name, origin, available) // 'Guinness', 'Heineken', 'Budwiser'
// }
...
var updatedCat = { ...cat, home: '삼산동러브하우스', color: '베이지'}; // 속성 수정 및 추가 가능
...
// async function f() {
//     try {
//         const data = await fetchData(); // 프로미스 객체가 결과를 리턴할 때까지 기다린다 (await은 async에서만 쓸 수 있음)
