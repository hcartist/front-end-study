...
// 2 사진 URL
// 클라이언트가 편하게 사진을 찾을 수 있도록 api서버에 생성해서 클라이언트한테 보내줌 > photoName으로 찾음
postSchema.virtual('photoUrls').get(function () {
    ...
    return urls;
}) // process.env.FILE_URL + '/photos/' + photoName > .env에서 생성한 파일 URL을 가리킴 /photos/는 FILE_URL 밑에 저장될 photo의 경로
